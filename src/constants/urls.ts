const URLS = {
  VIGNETTE: 'https://check.bgtoll.bg/check/vignette/plate/BG/',
  FINES:
    'https://e-uslugi.mvr.bg/api/Obligations/AND?obligatedPersonType=1&additinalDataForObligatedPersonType=3&mode=1',
  INSURANCE:
